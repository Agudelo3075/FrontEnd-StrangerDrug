        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{display: 'flex', alignItems: 'center', margin: '1.2rem 0'}}>
              ...
              />
              <label htmlFor="accept-terms" style={{fontSize: '1rem'}}>Acepto los términos y condiciones</label>
            </div>
            <button
              style={{
                width: '100%',
                padding: '0.9rem 0',
                background: termsChecked ? 'linear-gradient(90deg, #ff073a 0%, #ff2d55 100%)' : '#ccc',
                color: '#fff',
                fontWeight: 700,
                borderRadius: '12px',
                fontSize: '1.1rem',
                ...
                marginTop: '0.5rem',
                boxShadow: termsChecked ? '0 0 12px #ff073a99' : 'none',
                transition: 'all 0.2s',
              }}
